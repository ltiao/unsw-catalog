...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Meeting.day'
        db.alter_column(u'catalog_meeting', 'day', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Course.name'
        db.alter_column(u'catalog_course', 'name', self.gf('django.db.models.fields.CharField')(max_length=120))

    def backwards(self, orm):

        # Changing field 'Meeting.day'
        db.alter_column(u'catalog_meeting', 'day', self.gf('django.db.models.fields.CharField')(max_length=5))

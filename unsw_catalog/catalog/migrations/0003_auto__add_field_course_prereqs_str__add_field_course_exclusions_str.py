...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.prereqs_str'
        db.add_column(u'catalog_course', 'prereqs_str',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'Course.exclusions_str'
        db.add_column(u'catalog_course', 'exclusions_str',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.prereqs_str'
        db.delete_column(u'catalog_course', 'prereqs_str')

        # Deleting field 'Course.exclusions_str'
        db.delete_column(u'catalog_course', 'exclusions_str')
    ...
    models = {
        ...
        u'catalog.course': {
            ...
            'exclusions_str': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            ...
            'prereqs_str': ('django.db.models.fields.TextField', [], {'null': 'True'}),
        ...
        u'catalog.meeting': {
            ...
            'day': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Meeting.instructor'
        db.alter_column(u'catalog_meeting', 'instructor', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Meeting.instructor'
        db.alter_column(u'catalog_meeting', 'instructor', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'catalog.meeting': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructor': ('django.db.models.fields.CharField', [], {'max_length': '150'}),

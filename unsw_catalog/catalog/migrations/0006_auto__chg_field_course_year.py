...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'catalog_course', 'year', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Course.year'
        db.alter_column(u'catalog_course', 'year', self.gf('django.db.models.fields.DateField')())

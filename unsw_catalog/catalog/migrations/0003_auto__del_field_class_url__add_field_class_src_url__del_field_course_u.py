...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Class.url'
        db.delete_column(u'catalog_class', 'url')

        # Adding field 'Class.src_url'
        db.add_column(u'catalog_class', 'src_url',
        ...
        # Adding field 'Course.src_url'
        db.add_column(u'catalog_course', 'src_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=80),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Class.url'
        db.add_column(u'catalog_class', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=80),
                      keep_default=False)

        # Deleting field 'Class.src_url'
        db.delete_column(u'catalog_class', 'src_url')
        ...
        # Deleting field 'Course.src_url'
        db.delete_column(u'catalog_course', 'src_url')
